...
export const envSchema = z.object({
  ...
  BEDROCK_CODEX_MODEL: stringWithDefault("openai.gpt-oss-120b"),
...
export const configDocs: Record<ConfigKey, string> = {
  ...
  BEDROCK_CODEX_MODEL: "model every Codex request is served as on Bedrock (default openai.gpt-oss-120b; only gpt-oss models support the Responses API on Mantle)",
